...
public class BilibiliChannelExtractor extends ChannelExtractor {
    ...
    public static class ClientUserVideoImpl implements UserVideoImpl {
        ...
        public void collectVideos(
            ...
            for (int i = 0; i < results.size(); i++) {
                collector.commit(new BilibiliChannelInfoItemClientAPIExtractor(results.getObject(i), extractor.getName(), extractor.getAvatarUrl(), extractor.getUrl()));
            }
        }
    ...
    public static class SearchUserVideoImpl implements UserVideoImpl {
        ...
        public void collectVideos(
            ...
            for (int i = 0; i < results.size(); i++) {
                collector.commit(new BilibiliChannelInfoItemWebAPIExtractor(results.getObject(i), extractor.getName(), extractor.getAvatarUrl(), extractor.getUrl()));
            }
        }
    ...
    public static class WebUserVideoImpl implements UserVideoImpl {
        ...
        public void collectVideos(
            ...
            for (int i = 0; i < results.size(); i++) {
                collector.commit(new BilibiliChannelInfoItemWebAPIExtractor(results.getObject(i), null, null, extractor.getUrl()));
            }
        }
